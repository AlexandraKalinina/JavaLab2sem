...
public class UserRepositoriesImpl implements UserRepositories {
    ...
    private static final String SQL_INSERT = "insert into users(name, password, email, state, confirmcode) values (?,?,?,?,?)";
    ...
    public UserRepositoriesImpl(JdbcTemplate jdbcTemplate) {
    ...
    public void save(User object) {
        ...
        jdbcTemplate.update(connection -> {
            ...
            statement.setString(5,object.getConfirmCode());
            return statement;
        }, keyHolder);
    ...
    public void update(String confirm) {
        jdbcTemplate.update(SQL_UPDATE_STATE, confirm);
    }
}
